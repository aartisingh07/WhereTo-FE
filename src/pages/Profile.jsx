  ...
  const fetchProfileAndPlaces = useCallback(async () => {
    try {
      ...
      if (isOwnProfile) {
        ...
        // Set mock places representation for statistics count
    ...
    <div className="min-h-screen bg-dark-900 bg-grid pt-24 pb-12 px-4">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="glass-card p-8 text-center mb-6 animate-slide-up">
          ...
          <h1 className="font-display font-bold text-2xl text-white mb-1">{profileUser.username}</h1>
          {isOwnProfile && <p className="text-white/40 text-sm">{profileUser.email}</p>}
        </div>
          ...
          <div className="glass-card p-6 mb-6 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            {loadingPlaces ? (
              ...
              <div className="text-center py-8">
                ...
                <button onClick={() => navigate('/explore')} className="btn-primary text-sm !px-4 !py-2 cursor-pointer">
                  Explore places
                </button>
              </div>
            ) : (
                  ...
                  <div key={place._id} className="flex items-center gap-3 p-3 rounded-xl bg-white/3 border border-white/5 hover:bg-white/5 transition-all group">
                    ...
                    <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-red-500/10 flex items-center justify-center text-red-400 hover:bg-red-500/20 transition-colors cursor-pointer"
                      >
                        <FiTrash2 size={14} />
                      </button>
                    </div>
        ...
        {isOwnProfile && (
          <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 text-white/40 hover:text-white px-5 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all text-sm font-medium w-full sm:w-auto cursor-pointer"
            >
              <FiLogOut size={16} />
              Log out
            </button>
            <button
              ...
              className="inline-flex items-center justify-center gap-2 text-red-400 hover:text-red-300 px-5 py-2.5 rounded-xl bg-red-500/5 border border-red-500/10 hover:bg-red-500/10 hover:border-red-500/20 transition-all text-sm font-medium w-full sm:w-auto cursor-pointer"
            >
              <FiTrash2 size={16} />
              Delete Account
            </button>
